					...
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item"><a href="file_upload.jsp">Upload</a></li>
  ...
  <tr>
   ...
   <%
              ...
              while(rs.next())
              {
            	  ...
            	  String c=rs.getString("owner_name");
                  String d=rs.getString("filename");
            	   String e=rs.getString("filekey");                   
