				...
				<div class="bottom-header">
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
                                                                <li class="menu-item"><a href="userhomepage.jsp">Owner Home</a></li>
								<li class="menu-item"><a href="file_search.jsp">Search file</a></li>
                                                                <li class="menu-item"><a href="search2.jsp">Download file</a></li>
			...
			<main class="main-content">
				<div class="fullwidth-block greet-section">
					<div class="container">
						...
						<small class="section-subtitle">Download File</small>

                                          
                                                <%
                                                
                                           String pkey=request.getParameter("privatekey"); 
    ...
    <th>Download file</th>
     ...
     <%int fid = 0;
                                        ...
                                        try {
                                            ...
                                            rs = st.executeQuery("select * from upload where secret_key ='" + pkey + "' ");
                                            if (rs.next()) {
                                    ...
                                    <td> <a href="Down1?<%=rs.getString("id")%>"><font style="color: green">Download</a></font> </td>   
                                <tr />
