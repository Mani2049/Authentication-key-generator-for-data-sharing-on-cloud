...
<html lang="en">
	...
	<body>
        ...
        %>
        <script>alert('sent_to_Your_Email');</script>
        <%
            }
				...
				<div class="bottom-header">
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
                                                               <li class="menu-item"><a href="tpaloginpage.jsp">TPA Home</a></li>
								<li class="menu-item"><a href="urespones.jsp">User response</a></li>
                                                                <li class="menu-item"><a href="downdetails.jsp">Download view</a></li>
			...
			<main class="main-content">
				<div class="fullwidth-block greet-section">
					<div class="container">
						...
						<small class="section-subtitle">Response To User</small>
  ...
  <tr>
    ...
    <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from request where status='Yes'");
                                        while(rs.next())
                         ...
                         <td> <a href="u_mail.jsp?<%=rs.getString("id")%>"><font style="color: green">Send</a></font> </td>
