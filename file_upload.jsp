...
with Broadcast Aggregate Keys for Online Data Sharing on the Cloud</h1>
				...
				<div class="bottom-header">
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
                                                                <li class="menu-item"><a href="ownerhomepage.jsp">Owner Home</a></li>
								<li class="menu-item"><a href="upload.jsp">Upload</a></li>
                                                                <li class="menu-item"><a href="file_details.jsp">File details</a></li>
			...
			<div class="hero hero-slider">
				<ul class="slides">
					<li data-bg-image="dummy/upload.jpg">
						<div class="container">
			...
			<main class="main-content">
				...
				<div id="body">
                                    <div style="margin-left: 396px;" class="content">
               	<h2> Upload Here!!</h2>
                        <form action="upload" method="post" enctype="multipart/form-data">
                                <label for="pname"> <span>File Attribute</span>
                                    <input style="margin-left: 37px;" type="text" name="pname" placeholder="Enter File Name" required="" id="firstName"><br><br><br>
				</label>
				<label for="file"> <span></span>
                                    <input type="file" name="file" placeholder="file" required="" id="firstName"><br><br>
				</label>
			
                            </label>
				<input style="margin-left: 104px;width: 112px;" type="submit" value="upload" id="submit">
			</form>
		</div>
