				...
				<div id="body">
               	...
               	<h2> Search Here!!</h2>
                        <form action="search2.jsp" method="get">
                                <label for="pname"> <span>Private key</span>
                                    <input style="margin-left: 37px;" type="text" name="privatekey" placeholder="Enter File Name" required="" id="firstName"><br><br><br>
				</label>
                             <label for="pname"> <span>Aggregate key</span>
                                    <input style="margin-left: 37px;" type="text" name="akey" placeholder="Enter File Name" required="" id="firstName"><br><br><br>
				</label>
                            
				
                            </label>
				<input style="margin-left: 104px;width: 112px;" type="submit" value="check" id="submit">
			</form>
		</div>
